...
# ===== OBRÁZEK =====
THUMBNAIL_PATH = "new_generation_jalisco_cartel_logo.png"
...
async def on_member_join(member):
    ...
    if channel:
        ...
        if os.path.exists(THUMBNAIL_PATH):
            file = discord.File(THUMBNAIL_PATH, filename="new_generation_jalisco_cartel_logo.png")
            embed.set_thumbnail(url="attachment://new_generation_jalisco_cartel_logo.png")
...
async def sendcartel_slash(interaction: discord.Interaction):
    ...
    part1 = (
        ...
        "New Generation Jalisco Cartel nikdy nebyli o zbytečném hluku. "
